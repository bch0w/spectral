"""
Get station pair information from the CC stacks based on file names from the 
3-station EGF from

Liu et al. (2022)
    https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2022JB024885

Files:
    https://doi.org/10.5281/zenodo.7080282
"""
import os 
...
with open("station_pairs.txt", "w") as f:
    for dir_ in glob("*_stack"):
        phase, _, typ, _ = dir_.split("_")
...
with open("STATIONS_LIU2022", "w") as f:
    for netsta in sorted(netstas_b):
        ...
        f.write(f"{net:>6}{sta:>6}{lats[netsta]:11.4f}{lons[netsta]:11.4f}{0:7.1f}{0:7.1f}\n")
