 ...
 !
 ! maximum number of points per region =       177005
 !
 ! on NEC SX, make sure "loopcnt=" parameter
 ! in Makefile is greater than max vector length =       531015
 !
 ! total elements per slice =         2592
 ! total points per slice =       177005
 !
 ! the time step of the solver will be DT =   3.1500001E-02  (s)
 ! the (approximate) minimum period resolved will be =    3.860935      (s)
 !
 ...
 ! -----------------------------------------
 !
 ! angular size in first direction in degrees =    10.00000    
 ! angular size in second direction in degrees =    10.00000    
 !
 ! longitude of center in degrees =   -154.0000    
 ! latitude of center in degrees =    68.25000    
 !
 ! angle of rotation of the first chunk =   0.0000000E+00
 !
 ! corner            1
 ! longitude in degrees =   -164.958960174444     
 ! latitude in degrees =    62.9791063698581     
 !
 ! corner            2
 ! longitude in degrees =   -143.041039825556     
 ! latitude in degrees =    62.9791063698581     
 !
 ! corner            3
 ! longitude in degrees =   -170.826262188450     
 ! latitude in degrees =    72.6546738469061     
 !
 ! corner            4
 ! longitude in degrees =   -137.173737811550     
 ! latitude in degrees =    72.6546738469061     
 !
 ! resolution of the mesh at the surface:
 ! -------------------------------------
 !
 ! spectral elements along a great circle =         4608
 ! GLL points along a great circle =        18432
 ! average distance between points in degrees =   2.2321429E-02
 ! average distance between points in km =    2.482030    
 ! average size of a spectral element in km =    9.928119    
 !
 ...
 !
 ! size of static arrays per slice =    167.536884000000       MB
 !                                 =    159.775623321533       MiB
 !                                 =   0.167536884000000       GB
 !                                 =   0.156030882149935       GiB
 !
 ...
 !
 ! size of static arrays for all slices =    9382.06550400000       MB
 !                                      =    8947.43490600586       MiB
 !                                      =    9.38206550400000       GB
 !                                      =    8.73772940039635       GiB
 !                                      =   9.382065504000000E-003  TB
 !                                      =   8.532938867574558E-003  TiB
 !
 
 integer, parameter :: NEX_XI_VAL =          128
 integer, parameter :: NEX_ETA_VAL =          112
 
 integer, parameter :: NSPEC_CRUST_MANTLE =         2592
 integer, parameter :: NSPEC_OUTER_CORE =            0
 integer, parameter :: NSPEC_INNER_CORE =            0
 
 integer, parameter :: NGLOB_CRUST_MANTLE =       177005
 integer, parameter :: NGLOB_OUTER_CORE =            0
 integer, parameter :: NGLOB_INNER_CORE =            0
 
 integer, parameter :: NSPECMAX_ANISO_IC =            0
 
 integer, parameter :: NSPECMAX_ISO_MANTLE =         2592
 integer, parameter :: NSPECMAX_TISO_MANTLE =         2592
 integer, parameter :: NSPECMAX_ANISO_MANTLE =            0
 
 integer, parameter :: NSPEC_CRUST_MANTLE_ATTENUATION =         2592
 integer, parameter :: NSPEC_INNER_CORE_ATTENUATION =            0
 
 integer, parameter :: NSPEC_CRUST_MANTLE_STR_OR_ATT =         2592
 ...
 integer, parameter :: NSPEC_CRUST_MANTLE_STACEY =         2592
 integer, parameter :: NSPEC_OUTER_CORE_STACEY =            0
 
 integer, parameter :: NGLOB_CRUST_MANTLE_OCEANS =       177005
 ...
 integer, parameter :: NPROC_ETA_VAL =            7
 integer, parameter :: NCHUNKS_VAL =            1
 integer, parameter :: NPROCTOT_VAL =           56
 
 integer, parameter :: ATT1_VAL =            5
 integer, parameter :: ATT2_VAL =            5
 integer, parameter :: ATT3_VAL =            5
 integer, parameter :: ATT4_VAL =         2592
 integer, parameter :: ATT5_VAL =            0
 
 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_CM =          272
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_CM =          272
 ...
 integer, parameter :: NGLOB_XY_CM =       177005
 ...
 integer, parameter :: NT_DUMP_ATTENUATION_VAL =         1618
 ...
 double precision, parameter :: CENTER_LATITUDE_IN_DEGREES_VAL =    68.250000
 double precision, parameter :: CENTER_LONGITUDE_IN_DEGREES_VAL =  -154.000000
