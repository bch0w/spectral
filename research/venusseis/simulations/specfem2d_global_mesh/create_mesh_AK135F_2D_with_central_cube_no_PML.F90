...
! BC: Central cube creates the scaffolding, if it's too small then elements
! BC: start to get distorted as they transition from the outside to the cube
  double precision, parameter :: radius_cube = 650000.d0

! to inflate the central cube (set to 0.d0 for a non-inflated cube)
! BC: cube inflate turns central cube from a perfect square (0) to a cubed sphere (1)
...
! VENUS
  double precision, parameter :: R_EARTH = 6051800.d0

! ! BC values for VENUS (Dumoulin et al. 2017)
  double precision, parameter :: R670   = 5351800.d0
  double precision, parameter :: RCMB   = 3101800.d0
